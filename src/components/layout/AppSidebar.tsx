...
const navItems = [
  { title: '', url: '/app', icon: Home, end: true },
  { title: '', url: '/app/codex', icon: BookOpen },
  { title: ' ', url: '/app/new-documents', icon: FileText },
  { title: '', url: '/app/guide', icon: Compass },
  { title: '', url: '/app/calculator', icon: Calculator },
  // { title: ' ', url: '/app/forms', icon: FolderOpen },
  { title: '', url: '/app/search?type=classifier', icon: List },
  { title: ' ', url: '/app/calendar', icon: CalendarDays },
  { title: ' ', url: '/app/topics', icon: Info },
];

const personalItems = [
  { title: '', url: '/app/account/favorites', icon: Star },
  { title: '', url: '/app/account/notifications', icon: Bell, badge: true },
  { title: ' ', url: '/app/account/history', icon: Clock },
];
