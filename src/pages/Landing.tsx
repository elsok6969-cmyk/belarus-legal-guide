...
const popularSections = [
  { label: 'Трудовой кодекс', desc: '461 статья · Трудовые отношения', to: '/documents/296-з' },
  { label: 'Налоговый кодекс', desc: '382 статьи · Налоги и сборы', to: '/documents/166-з' },
  { label: 'Гражданский кодекс', desc: '1153 статьи · Гражданские правоотношения', to: '/documents/218-з' },
  { label: 'Уголовный кодекс', desc: '466 статей · Преступления и наказания', to: '/documents/275-з' },
  { label: 'КоАП', desc: '466 статей · Административные правонарушения', to: '/documents/91-з' },
  { label: 'Жилищный кодекс', desc: '224 статьи · Жилищные отношения', to: '/documents/428-з' },
  { label: 'Банковский кодекс', desc: '312 статей · Банковская деятельность', to: '/documents/441-з' },
  { label: 'Кодекс о браке и семье', desc: '241 статья · Семейные отношения', to: '/documents/278-з' },
  { label: 'Закон об ООО', desc: 'Хозяйственные общества', to: '/documents?q=хозяйственных+обществах' },
